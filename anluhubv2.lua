-- [[ 0. Pure Bypass & Anti-Kick (Fixed & Clean) ]]
...
RunService.Heartbeat:Connect(function()
    ...
    if _G.RageActive and _G.CurrentTargetPart then
        ...
        else _G.GhostPos = nil; Camera.CameraSubject = hum end
    ...
    else Camera.CameraSubject = hum; _G.GhostPos = nil end
...
print("[Anlu Hub] Perfect Integrated Final Loaded! 🚀👻✨")
